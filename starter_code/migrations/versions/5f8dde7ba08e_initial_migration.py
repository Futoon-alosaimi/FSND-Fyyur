...
Revision ID: 5f8dde7ba08e
Revises: 
Create Date: 2020-05-30 11:05:24.761152
...
def downgrade():
    ...
    op.add_column('Venue', sa.Column('seeking_description', sa.VARCHAR(length=128), autoincrement=False, nullable=True))
    ...
    op.add_column('Artist', sa.Column('seeking_description', sa.VARCHAR(length=255), autoincrement=False, nullable=True))
    # ### end Alembic commands ###
